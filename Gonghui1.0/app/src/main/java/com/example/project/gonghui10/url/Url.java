package com.example.project.gonghui10.url;

/**
 * Created by meng on 2016/7/21.
 */
public class Url {
    public final static String test_url = "http://49.140.166.110:8080/TestServer/api.jsp";
    public final static String test_url_servlet = "http://49.140.166.110:8080/TestServer/servlet/Login";
