...
import com.example.project.gonghui10.adapter.MyItemPicturesAdapter;
...
public class TuTu {
	...
	private MyItemPicturesAdapter myPagerAdapter;
	...
	private void initADViewpager() {
		...
		// 设置适配器
		myPagerAdapter = new MyItemPicturesAdapter(listADbeans);
		...
		int midPosition = Integer.MAX_VALUE / 2 - Integer.MAX_VALUE / 2
				% listADbeans.size();
		Log.i("info","midPosition:" + midPosition + "");
	...
	public void destoryViewParent() {
		myPagerAdapter.destoryParent();
	}
