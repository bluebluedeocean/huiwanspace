...
public class ItemDetailScrollView extends ScrollView {
	...
	public ItemDetailScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
	}

	public ItemDetailScrollView(Context context, AttributeSet attrs, int defStyle) {
		...
		switch (action) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if(isNeedMove()){
					...
					if(mView.getTop() - deltaY <1 && mView.getTop() -deltaY > -1){
